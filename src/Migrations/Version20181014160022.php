 ...
 */
final class Version20181014160022 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_user ADD created DATETIME NOT NULL, ADD modified DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_user DROP created, DROP modified');
    }
}

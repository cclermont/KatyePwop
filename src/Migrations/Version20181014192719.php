 ...
 */
final class Version20181014192719 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_institution ADD created DATETIME NOT NULL, ADD modified DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_institution DROP created, DROP modified');
    }
}

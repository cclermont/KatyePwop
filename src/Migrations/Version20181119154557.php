 ...
 */
final class Version20181119154557 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_institution ADD all_location_access TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_institution DROP all_location_access');
    }
}

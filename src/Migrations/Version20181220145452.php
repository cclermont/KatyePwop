 ...
 */
final class Version20181220145452 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_person CHANGE info bio LONGTEXT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_person CHANGE bio info LONGTEXT DEFAULT NULL COLLATE utf8mb4_unicode_ci');
    }
}

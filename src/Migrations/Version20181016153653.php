 ...
 */
final class Version20181016153653 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_profile ADD created DATETIME NOT NULL, ADD modified DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_profile DROP created, DROP modified');
    }
}

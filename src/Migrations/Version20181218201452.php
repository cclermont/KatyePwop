 ...
 */
final class Version20181218201452 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fuel (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT NOT NULL, pumped_at DATETIME DEFAULT NULL, merter_reading NUMERIC(10, 2) DEFAULT NULL, qty_pumped NUMERIC(10, 2) DEFAULT NULL, price_per_gallon NUMERIC(10, 2) DEFAULT NULL, last_mileage NUMERIC(10, 2) DEFAULT NULL, driver_id INT DEFAULT NULL, INDEX IDX_31BD6FE9545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

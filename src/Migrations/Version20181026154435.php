 ...
 */
final class Version20181026154435 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message_message (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, sender_id INT DEFAULT NULL, sender_institution_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, status INT NOT NULL, broadcasted TINYINT(1) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, INDEX IDX_26350A7364D218E (location_id), INDEX IDX_26350A73F624B39D (sender_id), INDEX IDX_26350A73C1ACA445 (sender_institution_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE institution_institution (id INT AUTO_INCREMENT NOT NULL, location_id INT DEFAULT NULL, image_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, type INT NOT NULL, enabled TINYINT(1) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, INDEX IDX_5C7FD7DA64D218E (location_id), UNIQUE INDEX UNIQ_5C7FD7DA3DA5256D (image_id), UNIQUE INDEX UNIQ_5C7FD7DA642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

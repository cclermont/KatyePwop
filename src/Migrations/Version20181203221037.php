 ...
 */
final class Version20181203221037 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_message_location_join DROP INDEX UNIQ_49C7D98164D218E, ADD INDEX IDX_49C7D98164D218E (location_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_message_location_join DROP INDEX IDX_49C7D98164D218E, ADD UNIQUE INDEX UNIQ_49C7D98164D218E (location_id)');
    }
}

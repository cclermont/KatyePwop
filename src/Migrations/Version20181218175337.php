 ...
 */
final class Version20181218175337 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE institution_institution (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, admin_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, type INT NOT NULL, enabled TINYINT(1) NOT NULL, all_location_access TINYINT(1) NOT NULL, created DATETIME NOT NULL, modified DATETIME NOT NULL, UNIQUE INDEX UNIQ_5C7FD7DA3DA5256D (image_id), UNIQUE INDEX UNIQ_5C7FD7DA642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');

 ...
 */
final class Version20190529145440 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_institution CHANGE branding_color branding_color VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE institution_institution CHANGE branding_color branding_color VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}

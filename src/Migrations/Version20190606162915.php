 ...
 */
final class Version20190606162915 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_message CHANGE sending_date sending_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_message CHANGE sending_date sending_date DATETIME NOT NULL');
    }
}

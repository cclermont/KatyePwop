 ...
 */
final class Version20190606162803 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_message ADD regular TINYINT(1) NOT NULL, ADD sending_date DATETIME NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message_message DROP regular, DROP sending_date');
    }
}
